...
class PreprocessElement(PipelineElement):
            ...
            for row in reader:
                ...
                for col in row:
                    ...
                    if '&' in col:
                        ...
                        homonym_with_context_marker = f"{base_word}{re.sub(r'_', r'&', suffix, count=1)}"

                    homonyms_dict[f'{base_word}{suffix}'.replace('&', '_').upper()] = homonym_with_context_marker.upper()
    ...
    def _replace_context_markers(self, sentence):
        ...
        replaced_sentence = re.sub(r'(\w+)_(CIDADE|ESTADO|PAÍS|FAMOSO)', r'\1&\2', replaced_sentence)
    ...
    def _replace_directionality_syntax(self, sentence):
        ...
        sentence = re.sub(r'([123][SP])_([\w)(&+-]+)_([123][SP])', r'\2_\1_\3', sentence)
