...
class TestIntensityAugmentation(unittest.TestCase):
    ...
    def test_data_without_augmentation(self):
        ...
        length = 2
        augmentation = IntensidadeAugmentation(PATH_INTENSIFIERS,
                                               max_new_sentences = length)
    ...
    def test_data_data_augmentation(self):
        ...
        corpus = [('TOM SER GERALMENTE MUITO SUJO MUITO SORTUDO [PONTO]','TOM GERALMENTE SUJO(+) SORTUDO(+) [PONTO]'),
